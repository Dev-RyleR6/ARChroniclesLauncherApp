...
public class LandmarkDetailFragmentDirections private constructor() {
  private data class ActionDetailToMap(
    ...
    public override val actionId: Int = R.id.actionDetailToMap
  ...
  public companion object {
    public fun actionDetailToMap(
      landmarkTitle: String?,
      landmarkDescription: String?,
      landmarkImageResId: Int,
      latitude: Float,
      longitude: Float,
    ): NavDirections = ActionDetailToMap(landmarkTitle, landmarkDescription, landmarkImageResId,
        latitude, longitude)
  }
}
