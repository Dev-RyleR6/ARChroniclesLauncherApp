...
public data class LandmarkDetailFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): LandmarkDetailFragmentArgs {
      bundle.setClassLoader(LandmarkDetailFragmentArgs::class.java.classLoader)
      val __landmarkTitle : String?
      if (bundle.containsKey("landmarkTitle")) {
        __landmarkTitle = bundle.getString("landmarkTitle")
        if (__landmarkTitle == null) {
          throw IllegalArgumentException("Argument \"landmarkTitle\" is marked as non-null but was passed a null value.")
        }
      } else {
      ...
      if (bundle.containsKey("landmarkDescription")) {
        ...
        if (__landmarkDescription == null) {
          throw IllegalArgumentException("Argument \"landmarkDescription\" is marked as non-null but was passed a null value.")
        }
      } else {
      ...
      return LandmarkDetailFragmentArgs(__landmarkTitle, __landmarkDescription,
          __landmarkImageResId, __latitude, __longitude)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        LandmarkDetailFragmentArgs {
      val __landmarkTitle : String?
