...
public final class MarkerInfoWindowBinding implements ViewBinding {
  ...
  private MarkerInfoWindowBinding(@NonNull LinearLayout rootView, @NonNull Button detailsButton,
  ...
  public static MarkerInfoWindowBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MarkerInfoWindowBinding((LinearLayout) rootView, detailsButton, snippet, title);
    }
